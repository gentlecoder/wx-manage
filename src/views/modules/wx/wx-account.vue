  ...
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template v-slot="scope">
          <el-button link size="small" @click="accessInfo(scope.row)">接入</el-button>
          <el-button link size="small" @click="addOrUpdateHandle(scope.row)">修改</el-button>
          <el-button link size="small" @click="deleteHandle(scope.row.appid)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 弹窗, 新增 / 修改 -->
