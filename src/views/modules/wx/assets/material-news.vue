            ...
            <div class="card" :key="item.mediaId" v-if="i % rows == n - 1" @click="onSelect(item)">
              ...
              <div class="card-footer">
                ...
                <div class="flex justify-between align-center" v-show="!selectMode">
                  <el-button size="mini" link icon="el-icon-copy-document" v-clipboard:copy="item.mediaId"
                    v-clipboard:success="onCopySuccess" v-clipboard:error="onCopyError">复制media_id</el-button>
                  <el-button size="mini" link icon="el-icon-edit" @click="addOrUpdateHandle(item)">编辑</el-button>
                  <el-button size="mini" link icon="el-icon-delete" @click="deleteHandle(item.mediaId)">删除</el-button>
                </div>
              </div>
            </div>
          </template>
