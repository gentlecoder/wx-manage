<template>
  <div>
      ...
      <el-form :inline="true" :model="dataForm" @keyup.enter="getDataList()">
        <el-form-item>
          <el-select v-model="dataForm.type" placeholder="选择文章类型">
            <el-option v-for="(name, key) in ARTICLE_TYPES" :key="key" :label="name" :value="key"
        ...
        <el-form-item>
          ...
          <el-button v-if="isAuth('wx:article:delete')" type="danger" @click="deleteHandle()"
    ...
    <!-- 新增 / 修改  -->
    <add-or-update :visible="addOrUpdateVisible" ref="addOrUpdate" @refreshDataList="getDataList"
