  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('wx:msgtemplate:save')" type="success" @click="copyHandle()"
          :disabled="dataListSelections.length <= 0">批量复制</el-button>
        <el-button v-if="isAuth('wx:msgtemplate:save')" type="success" @click="templateMsgTaskHandle()"
          :disabled="dataListSelections.length != 1">推送消息</el-button>
      ...
      <el-form-item class="fr">
        <el-button v-if="isAuth('wx:msgtemplate:save')" icon="el-icon-sort" type="success" @click="syncWxTemplate()"
          :disabled="synchonizingWxTemplate">{{ synchonizingWxTemplate ? '同步中...' : '同步公众号模板' }}</el-button>
        <el-button><el-link type="primary" icon="el-icon-link" target="_blank"
            href="https://kf.qq.com/faq/170209E3InyI170209nIF7RJ.html">模板管理指引</el-link></el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template v-slot="scope">
          <el-button link size="small" @click="addOrUpdateHandle(scope.row.id)">配置</el-button>
          <el-button link size="small" @click="deleteHandle(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
