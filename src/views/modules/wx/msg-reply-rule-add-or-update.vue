  ...
  <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" v-modal:visible="visible">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="80px">
      ...
      <el-form-item label="回复内容" prop="replyContent">
        ...
        <el-button link v-show="assetsType" @click="assetsSelectorVisible = true">
    ...
    <assets-selector v-if="assetsSelectorVisible && assetsType" :visible="assetsSelectorVisible" :selectType="assetsType"
      @selected="onAssetsSelect" @onClose="assetsSelectorVisible = false"></assets-selector>
  </el-dialog>
</template>
