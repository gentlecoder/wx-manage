<template>
    <el-dialog title="筛选模板消息目标用户" :close-on-click-modal="false" v-modal:visible="visible">
        <el-form :inline="true" :model="dataForm" ref="dataForm" clearable @keyup.enter="getWxUsers()">
            <el-form-item>
        ...
        <span slot="footer" class="dialog-footer">
            <el-button @click="send" type="success" :disabled="totalCount <= 0 || sending">{{ sending ? '发送中...' : '发送'
            }}</el-button>
